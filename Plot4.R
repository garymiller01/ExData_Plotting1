...
# 4.1 = Plot 2 with modified Y axis label
...
# 4.2 = Plot 3 with modified legend
...
plot(finalDf$DateTime2,finalDf$Voltage,type="n",
     ylab="Voltage",
     xlab="datetime")
lines(finalDf$DateTime2,finalDf$Voltage,col="black",lty=1)

# 4.4

plot(finalDf$DateTime2,finalDf$Global_reactive_power,type="n",
     ylab="Global_reactive_power",
     xlab="datetime")
lines(finalDf$DateTime2,finalDf$Global_reactive_power,col="black",lty=1,lwd=1)
